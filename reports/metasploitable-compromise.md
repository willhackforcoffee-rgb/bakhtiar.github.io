---
layout: default
title: Metasploitable 2 Exploitation Report
---
...
**Date:** March 21, 2026  
**Status:** <span style="color: red; font-weight: bold;">CRITICAL RISK (Full System Compromise)</span>
...
* **Shadow File Analysis:** Exfiltrated `/etc/passwd` and `/etc/shadow`.
